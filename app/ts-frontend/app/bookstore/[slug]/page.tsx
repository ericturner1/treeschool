...
export default async function WorkbookProductPage({ params, searchParams }: Props) {
  ...
  const faqs = [
    ...
    {
      question: "Do I need a Treeschool Family Plan to buy it?",
      answer: `No. You can purchase the standalone PDF for ${price} without a Family Plan. Enter your delivery email at checkout and Treeschool will send the download link after payment.`
    },
    {
      question: "Can I use it with the Treeschool lesson planner?",
      answer: workbook.type === "core"
        ? "Yes. Active Family Plan members can add this core material directly to a student's lesson plan. The planner organizes selected workbook material into printable weekly lesson plans."
